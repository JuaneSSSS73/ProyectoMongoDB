...
CREATE TABLE `libro_autor` (
  ...
  CONSTRAINT `libro_autor_ibfk_1` FOREIGN KEY (`autor_id`) REFERENCES `autor` (`id`),
  CONSTRAINT `libro_autor_ibfk_2` FOREIGN KEY (`libro_id`) REFERENCES `libro` (`id`)
...
-- Dump completed on 2025-03-25 23:57:33
